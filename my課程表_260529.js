        ...
        let lessons = JSON.parse(localStorage.getItem('lessons_auto_2026_v2')) || [
            ...
            { name: '第七節：生科_713', start: '14:55', end: '15:40', alertBefore: 5, totalNum: 28, presentNum: 28, note: '' },
                ...
                // 預設課表（新增 totalNum, presentNum, note 屬性）
        let lessons = JSON.parse(localStorage.getItem('lessons_auto_2026_v2')) || [
            { name: '第一節：自修', start: '08:25', end: '09:10', alertBefore: 5, totalNum: 20, presentNum: 20, note: '' },
            { name: '第二節：生科_901', start: '09:20', end: '10:05', alertBefore: 5, totalNum: 18, presentNum: 18, note: '' },
            { name: '第三節：生科_802', start: '10:15', end: '11:00', alertBefore: 5, totalNum: 23, presentNum: 23, note: '' },
            { name: '第四節：生科_701', start: '11:10', end: '11:55', alertBefore: 5, totalNum: 23, presentNum: 23, note: '' },
            { name: '第五節：自修', start: '13:00', end: '13:45', alertBefore: 5, totalNum: 22, presentNum: 22, note: '' },
            { name: '第六節：自修', start: '13:55', end: '14:40', alertBefore: 5, totalNum: 22, presentNum: 22, note: '' },
            { name: '第七節：自修', start: '14:55', end: '15:40', alertBefore: 5, totalNum: 20, presentNum: 20, note: '' },
                ...
                // 預設課表（新增 totalNum, presentNum, note 屬性）
        let lessons = JSON.parse(localStorage.getItem('lessons_auto_2026_v2')) || [
            { name: '第一節：生科_702', start: '08:25', end: '09:10', alertBefore: 5, totalNum: 23, presentNum: 23, note: '' },
            { name: '第二節：生科_801', start: '09:20', end: '10:05', alertBefore: 5, totalNum: 23, presentNum: 23, note: '' },
            { name: '第三節：自修', start: '10:15', end: '11:00', alertBefore: 5, totalNum: 22, presentNum: 22, note: '' },
            { name: '第四節：生科_902', start: '11:10', end: '11:55', alertBefore: 5, totalNum: 19, presentNum: 19, note: '' },
            { name: '第五節：自修', start: '13:00', end: '13:45', alertBefore: 5, totalNum: 22, presentNum: 22, note: '' },
            { name: '第六節：自修', start: '13:55', end: '14:40', alertBefore: 5, totalNum: 22, presentNum: 22, note: '' },
